...
export const SELECTED_SECTION_NAME = "SELECTED_SECTION_NAME";
...
export const IS_QUESTIONS_EMPTY = "IS_QUESTIONS_EMPTY";
export const IS_QUESTIONS_FULL = "IS_QUESTIONS_FULL";

export const QUESTIONS_LOADING = "QUESTIONS_LOADING";
export const EXAM_SAVED_LOADING = "EXAM_SAVED_LOADING";
export const LOGIN_LOADING = "LOGIN_LOADING";
export const REGISTER_LOADING = "REGISTER_LOADING";
export const SCHOOL_SUBMIT_LOADING = "SCHOOL_SUBMIT_LOADING";
export const QUESTION_SAVE_LOADING = "QUESTION_SAVE_LOADING";
export const EXAM_INFO_LOADING = "EXAM_INFO_LOADING";
export const SEARCH_LOADING = "SEARCH_LOADING";
export const OTHER_TESTS_LOADING = "OTHER_TESTS_LOADING";
export const MODAL_OK_LOADING = "MODAL_OK_LOADING";
export const DELETE_LOADING = "DELETE_LOADING";

export const ROLE = "ROLE";

export const QUESTIONS_DRAWER = "QUESTIONS_DRAWER";
